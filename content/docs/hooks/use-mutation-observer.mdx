...
```bash
npx shadcn@latest add "https://h3-use.com/r/use-mutation-observer"
```
...
| ---------- | ---------------------- | --------- | ------------------------------------------- |
| `target`   | `HTMLElement \| null`  | -         | The DOM element to observe                  |
...
| `characterData`         | `boolean`  | `false` | Whether to observe changes to the character data of text nodes            |
| `attributeOldValue`     | `boolean`  | `false` | Whether to record the previous value of attributes when they change       |
| `characterDataOldValue` | `boolean`  | `false` | Whether to record the previous value of character data when it changes    |
