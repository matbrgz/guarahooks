...
| `initialValue` | `unknown`                  | -       | The initial value to store in session storage |
...
| Prop           | Type                     | Default          | Description                           |
| -------------- | ------------------------ | ---------------- | ------------------------------------- |
| `serialize?`   | `(value: unknown) => string` | `JSON.stringify` | The function to serialize the value   |
| `deserialize?` | `(value: string) => unknown` | `JSON.parse`     | The function to deserialize the value |
