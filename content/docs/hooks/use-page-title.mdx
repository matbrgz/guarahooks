...
```bash
npx shadcn@latest add "https://h3-use.com/r/use-page-title"
```
...
- [React Helmet](mdc:https://github.com/nfl/react-helmet)
- [Next.js Head Component](mdc:https://nextjs.org/docs/api-reference/next/head)
