...
| Merge the provided headers into the instance defaults and save them for future requests |
...
| `resetBaseURL`
| `() => void`
| Reset the base URL to the current prop value |
| `resetTimeout`
| `() => void`
| Reset the request timeout to the current prop value |
| `resetConfig`
| `() => void`
| Reset Axios options to the current prop value |
