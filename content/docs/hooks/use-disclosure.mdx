...
```bash
npx shadcn@latest add "https://h3-use.com/r/use-disclosure"
```
...
1. `isOpen`: The current state of the disclosure
2. An object containing control functions:
   - `open`: Function to open the disclosure
   - `close`: Function to close the disclosure
   - `toggle`: Function to toggle the disclosure state
