...
```bash
npx shadcn@latest add "https://h3-use.com/r/use-event-listener"
```
...
- [MDN Web Docs: addEventListener](mdc:https://developer.mozilla.org/en-US/docs/Web/API/EventTarget/addEventListener)
- [React Hooks API Reference](mdc:https://reactjs.org/docs/hooks-reference.html)
